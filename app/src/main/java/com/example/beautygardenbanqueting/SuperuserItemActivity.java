...
public class SuperuserItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_superuser_item);
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()  && snapshot.getValue() != null) {
                            ...
                            // immagine
                            Glide.with(SuperuserItemActivity.this)
                                    .load(item.getImage())
                                    .into(image);
                            // prezzo
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(SuperuserItemActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
    }
    ...
    private void onClick(View view) {
        switch(view.getId()) {
            case R.id.editButton:
                startActivity(new Intent(SuperuserItemActivity.this, EditItemActivity.class).putExtra("id", itemId));
                break;
                ...
                itemRef.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(SuperuserItemActivity.this, "Sala rimossa correttamente", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(SuperuserItemActivity.this, SuperHomeActivity.class));
